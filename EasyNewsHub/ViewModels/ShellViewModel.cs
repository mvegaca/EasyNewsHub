...
namespace EasyNewsHub.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<FeedListPage>("Shell_NewsFeeds".GetLocalized(), Symbol.Document));
            _secondaryItems.Add(ShellNavigationItem.FromType<SettingsPage>("Shell_Settings".GetLocalized(), Symbol.Setting));
            _primaryItems.Add(ShellNavigationItem.FromType<NewsDetailsPage>("Shell_NewsDetails".GetLocalized(), Symbol.Document));
        }
